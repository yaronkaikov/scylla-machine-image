...
ENV_TAG="candidate"
if [[ $(cat build/SCYLLA-VERSION-FILE) == *"dev" ]]; then
  ENV_TAG="daily"
fi
...
print_usage() {
    ...
    echo "  [--env-tag]             Environment tag for our images. default: daily for master and candidate for releases. Valid options: debug and production"
